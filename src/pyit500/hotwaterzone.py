...
from pyit500.zone import Zone, ZoneAttribute, ScheduleType, OnOffStatus
from pyit500.enumfriendly import IntEnumFriendly
...
class HotWaterZone(Zone):
    ...
    def boost_remaining_hours(self) -> int:
        ...
        return int(self.get_attr(ZoneAttribute.HW_BOOST_REMANING_HOURS))
